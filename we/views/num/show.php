                                         ...
                                         <?php foreach($list as  $k=>$v) {?>
                                            <tr class="gradeA">
                                                ...
                                                <td><?php echo $v['we_type']?></td>
                                                    ...
                                                    <td><a href="index.php?r=num/del&id=<?php echo $v['number_id']?>">删除</a>
                                                        || <a href="index.php?r=num/up&id=<?php echo $v['number_id']?>">修改</a>
                                                        || <a href="index.php?r=num/qie&id=<?php echo $v['number_id']?>">
